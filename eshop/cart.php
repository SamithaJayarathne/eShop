                            ...
                            <div class="col-12 col-lg-9">
                                <div class="row">
                                    ...
                                    city.district_district_id=district.district_id WHERE `users_email`='" . $user . "'");
                                        ...
                                        product.condition_condition_id=condition.condition_id WHERE `id`='" . $cart_data["product_id"] . "'");
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="fw-bold text-black fs-5"><?php echo $product_data["price"]; ?></span>
                                                        <br>
                                                ...
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-md-6 text-end">
                                                            <span class="fw-bold fs-5 text-black-50">Rs. <?php echo $product_data["price"] + $shipping; ?> .00</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
