                  ...
                  <div class="row">
                      ...
                      <div class="col-12 col-lg-6 d-none" id="SignInBox">
                          <div class="row g-2">
                              ...
                              <div class="col-12">
                                  <label class="form-label">Email</label>
                                  <input class="form-control" type="email" id="email2" value="<?php echo $email; ?>" placeholder="ex:martin@gmail.com" />
                              </div>

                              <div class="col-12">
                                  <label class="form-label">Password</label>
                                  <input class="form-control" type="password" id="password2" value="<?php echo $password; ?>" placeholder="********" />
                              </div>
